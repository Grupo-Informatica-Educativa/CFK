...
app.add_app("Posttest Inicial", posttest_inicial.app)
app.add_app("Pre - Post tests Inicial", prepost_inicial.app)
app.add_app("Pretest Avanzado", pretest_avanzado.app)
app.add_app("Posttest Avanzado", posttest_avanzado.app)
app.add_app("Pre - Post tests Avanzado", prepost_avanzado.app)
...
app.add_app("GreenTIC: Género y actitudes ambientales",
            genero_y_actitudes_ambientales_piloto_beta.app)
