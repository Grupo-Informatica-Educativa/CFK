...
df_inicial = pd.read_csv('data/crudos/postest_inicial.csv',
                         error_bad_lines=False, warn_bad_lines=False,
                         low_memory=False)
df_avanzado = pd.read_csv('data/crudos/postest_avanzado.csv',
                          error_bad_lines=False, warn_bad_lines=False,
                          low_memory=False)
# Filtrar solo postest
df_inicial = df_inicial[df_inicial.Encuesta == 'U4 Cuestionario Final (25 puntos)']
df_avanzado = df_avanzado[df_avanzado.Encuesta == 'UA4 Cuestionario final (15 puntos)']
...
pivot_inicial.columns = [col.replace("\n", " ").strip() for col in pivot_inicial.columns.to_numpy()]
