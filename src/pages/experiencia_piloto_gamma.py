...
def app():
	...
	if file:
		...
		preguntas = np.concatenate((np.array(columnas[col_preguntas:indices_preguntas[0] + 1]),
									...
									np.array(columnas[indices_preguntas[3]: indices_preguntas[4] + 1]),
									np.array(columnas[indices_preguntas[5]]),
									np.array(columnas[indices_preguntas[6]: indices_preguntas[7] + 1]),
		...
		for i in indices:
			if i in arreglo_multi_respuesta:
				if i == arreglo_multi_respuesta[0]:
					...
					repeticiones = 14
					respuestas = np.array(columnas[indices_preguntas[5] + 1:indices_preguntas[5] + repeticiones])
				else:
					repeticiones = 9
					respuestas = np.array(columnas[indices_preguntas[7] + 1:indices_preguntas[7] + repeticiones])
